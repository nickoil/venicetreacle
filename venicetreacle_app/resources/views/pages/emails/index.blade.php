                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form id="universal-search-form" method="GET">
                        ...
                        <div class="min-w-full flex flex-wrap mb-4">
                            <x-filter-box :title="__('To Address')">    
                                <x-filter-text :name="'email_address'" />
                            </x-filter-box>
                            <x-filter-box :title="__('Type')">
                                <x-filter-select :name="'message_type'" :items=$messageTypes :selected="Request::input('message_type')"/>
                            </x-filter-box>
                            <x-filter-box :title="__('Sent Date From')">    
                                <x-filter-date :name="'sent_date_from'" />
                            </x-filter-box>
                            <x-filter-box :title="__('Sent Date To')">    
                                <x-filter-date :name="'sent_date_to'" />
                            </x-filter-box>
                            <x-filter-box :title="__('Status')">
                                <x-filter-select :name="'email_status_id'" :items=$emailStatuses :selected="Request::input('email_status_id')" />
                            </x-filter-box>
                        </div>
                    </form>
