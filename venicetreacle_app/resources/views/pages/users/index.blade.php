            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div>
                            <x-primary-button-link href="{{ route($route . '.create') }}" >
                    ...
                    <form id="universal-search-form" method="GET">
                        ...
                        <div class="min-w-full flex flex-wrap mb-4">
                            <x-filter-box :title="__('Name')">
                                <x-filter-text :name="'name'" />
                            </x-filter-box>
                            <x-filter-box :title="__('Email')">    
                                <x-filter-text :name="'email'" />
                            </x-filter-box>
                            <x-filter-box :title="__('Role')">
                                <x-filter-select :name="'role_id'" :items=$roles :selected="Request::input('role_id')" />
                            </x-filter-box>
                            <x-filter-box :title="__('Suspended')">
                                <x-filter-select :name="'suspended'" :items=$suspendedOptions :selected="Request::input('suspended')"/>
                            </x-filter-box>
                        </div>
                    </form>
